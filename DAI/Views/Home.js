import { View, Text, StyleSheet, StatusBar, TouchableOpacity, Button, Linking, ImageBackground, ScrollView } from 'react-native'
...
const Home = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ flexDirection: "row", marginTop: 60, justifyContent: "space-around" }}>
      <TouchableOpacity onPress={()=> navigation.navigate("Vibrator")}>
        <Icon5 name="asterisk" size={80} color="purple" />
      </TouchableOpacity>
